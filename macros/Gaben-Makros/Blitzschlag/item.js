// ==========================================
        ...
        // ==========================================
        const gabenName = "Blitzschlag (Rondra)";
        const aepKosten = 4;
        const macroLink = "@UUID[Compendium.dsk-havena-und-umland.makros.Macro.Xl6Oi7uDa66vl7MC]{Blitzschlag aktivieren}";
        ...
        (async () => {
            ...
            if (currentAeP < aepKosten) {
                ...
                htmlInhalt = `
                    ...
                    <hr style="margin: 8px 0; border: 0; border-top: 1px solid #c9bca6;">
                    <p style="margin-bottom: 8px;">Klicke hier, um den Blitzschlag auf deine Klinge zu kanalisieren:</p>
