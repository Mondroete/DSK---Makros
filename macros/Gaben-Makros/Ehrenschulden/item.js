// ==========================================
        ...
        const aepKosten = 4;
        const macroLink = "@UUID[Compendium.dsk-havena-und-umland.makros.Macro.53tkdV3cZEwV7hHo]{Schulden besiegeln}";
        ...
        (async () => {
            ...
            if (currentAeP < aepKosten) {
                ...
                htmlInhalt = `
                    ...
                    <hr style="margin: 8px 0; border: 0; border-top: 1px solid #c9bca6;">
                    <p style="margin-bottom: 8px;">Bitte wähle dein Ziel (den Wettpartner) per Target und klicke hier:</p>
