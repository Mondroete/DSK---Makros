...
![Framework – UUID kopieren](macros/Bilder/01-framework-uuid.png)
...
![Item – Effekt → Macro‑Feld](macros/Bilder/03-item-macro-field.png)
...
![Gaben‑Macro – Macro‑UUID](macros/Bilder/02-gaben-macro-uuid.png)
