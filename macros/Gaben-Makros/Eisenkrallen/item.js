// ==========================================
        ...
        const aepKosten = 4;
        const macroLink = "@UUID[Compendium.dsk-havena-und-umland.makros.Macro.pfwhAyZ61aQimLAK]{Krallen wirken}";
        ...
        (async () => {
            ...
            if (currentAeP < aepKosten) {
                ...
                htmlInhalt = `
                    ...
                    <hr style="margin: 8px 0; border: 0; border-top: 1px solid #c9bca6;">
                    <p style="margin-bottom: 8px;">Bitte wähle Ziel(e) per Target und klicke hier:</p>
